 ...
 */
class AppsCountries extends \VesselBundle\Entity\AppsCountries implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'VesselBundle\\Entity\\AppsCountries' . "\0" . 'id', '' . "\0" . 'VesselBundle\\Entity\\AppsCountries' . "\0" . 'countryCode', '' . "\0" . 'VesselBundle\\Entity\\AppsCountries' . "\0" . 'countryName'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AppsCountries $proxy) {
