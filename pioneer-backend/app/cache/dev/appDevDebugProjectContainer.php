...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'acme_api.event.authentication_failure_listener' => 'getAcmeApi_Event_AuthenticationFailureListenerService',
            'acme_api.event.jwt_invalid_listener' => 'getAcmeApi_Event_JwtInvalidListenerService',
            'acme_api.event.jwt_response_listener' => 'getAcmeApi_Event_JwtResponseListenerService',
            ...
            'doctrine_cache.providers.gearman_cache' => 'getDoctrineCache_Providers_GearmanCacheService',
            'executenodefindcolor.worker' => 'getExecutenodefindcolor_WorkerService',
            ...
            'gearman' => 'getGearmanService',
            'gearman.cache.wrapper' => 'getGearman_Cache_WrapperService',
            'gearman.command.cache_clear' => 'getGearman_Command_CacheClearService',
            'gearman.command.cache_warmup' => 'getGearman_Command_CacheWarmupService',
            'gearman.command.job_describe' => 'getGearman_Command_JobDescribeService',
            'gearman.command.job_execute' => 'getGearman_Command_JobExecuteService',
            'gearman.command.worker_describe' => 'getGearman_Command_WorkerDescribeService',
            'gearman.command.worker_execute' => 'getGearman_Command_WorkerExecuteService',
            'gearman.command.worker_list' => 'getGearman_Command_WorkerListService',
            'gearman.describer' => 'getGearman_DescriberService',
            'gearman.dispatcher.callbacks' => 'getGearman_Dispatcher_CallbacksService',
            'gearman.execute' => 'getGearman_ExecuteService',
            'gearman.external.symfony_finder' => 'getGearman_External_SymfonyFinderService',
            'gearman.parser' => 'getGearman_ParserService',
            'gearman.unique_job_identifier' => 'getGearman_UniqueJobIdentifierService',
            ...
            'lexik_jwt_authentication.extractor.chain_extractor' => 'getLexikJwtAuthentication_Extractor_ChainExtractorService',
            ...
            'log.update.listener' => 'getLog_Update_ListenerService',
        ...
        $this->aliases = array(
            'console.command.mmoreram_gearmanbundle_command_gearmancacheclearcommand' => 'gearman.command.cache_clear',
            'console.command.mmoreram_gearmanbundle_command_gearmancachewarmupcommand' => 'gearman.command.cache_warmup',
            'console.command.mmoreram_gearmanbundle_command_gearmanjobdescribecommand' => 'gearman.command.job_describe',
            'console.command.mmoreram_gearmanbundle_command_gearmanjobexecutecommand' => 'gearman.command.job_execute',
            'console.command.mmoreram_gearmanbundle_command_gearmanworkerdescribecommand' => 'gearman.command.worker_describe',
            'console.command.mmoreram_gearmanbundle_command_gearmanworkerexecutecommand' => 'gearman.command.worker_execute',
            'console.command.mmoreram_gearmanbundle_command_gearmanworkerlistcommand' => 'gearman.command.worker_list',
    ...
    /**
     * Gets the 'acme_api.event.authentication_failure_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\EventListener\AuthenticationSuccessListener A UserBundle\EventListener\AuthenticationSuccessListener instance
     */
    protected function getAcmeApi_Event_AuthenticationFailureListenerService()
    {
        return $this->services['acme_api.event.authentication_failure_listener'] = new \UserBundle\EventListener\AuthenticationSuccessListener();
    }

    /**
     * Gets the 'acme_api.event.jwt_invalid_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\EventListener\AuthenticationSuccessListener A UserBundle\EventListener\AuthenticationSuccessListener instance
     */
    protected function getAcmeApi_Event_JwtInvalidListenerService()
    {
        return $this->services['acme_api.event.jwt_invalid_listener'] = new \UserBundle\EventListener\AuthenticationSuccessListener();
    }

    /**
     * Gets the 'acme_api.event.jwt_response_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\EventListener\AuthenticationSuccessListener A UserBundle\EventListener\AuthenticationSuccessListener instance
     */
    protected function getAcmeApi_Event_JwtResponseListenerService()
    {
        return $this->services['acme_api.event.jwt_response_listener'] = new \UserBundle\EventListener\AuthenticationSuccessListener();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\EventListener\JWTAuthenticator A UserBundle\EventListener\JWTAuthenticator instance
     */
    protected function getApp_JwtTokenAuthenticatorService()
    {
        return $this->services['app.jwt_token_authenticator'] = new \UserBundle\EventListener\JWTAuthenticator($this->get('lexik_jwt_authentication.jwt_manager'), $this->get('debug.event_dispatcher'), $this->get('lexik_jwt_authentication.extractor.chain_extractor'));
    }
    ...
    {
        return $this->services['cache_clearer'] = new \Symfony\Component\HttpKernel\CacheClearer\ChainCacheClearer(array(0 => $this->get('gearman.cache.wrapper')));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('lexik_jwt_authentication.on_authentication_success', array(0 => 'acme_api.event.jwt_response_listener', 1 => 'onAuthenticationSuccessResponse'), 0);
        $instance->addListenerService('lexik_jwt_authentication.on_authentication_failure', array(0 => 'acme_api.event.authentication_failure_listener', 1 => 'onAuthenticationFailureResponse'), 0);
        $instance->addListenerService('lexik_jwt_authentication.on_jwt_not_found', array(0 => 'acme_api.event.jwt_invalid_listener', 1 => 'onJWTNotFound'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'preUpdate'), $this->get('log.update.listener'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'incident', 'user' => 'root', 'password' => 'star123', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/VesselBundle/Entity'), 2 => ($this->targetDirs[3].'/src/DashboardBundle/Entity'), 3 => ($this->targetDirs[3].'/src/RankingBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'UserBundle\\Entity');
        $c->addDriver($b, 'VesselBundle\\Entity');
        $c->addDriver($b, 'DashboardBundle\\Entity');
        $c->addDriver($b, 'RankingBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('UserBundle' => 'UserBundle\\Entity', 'VesselBundle' => 'VesselBundle\\Entity', 'DashboardBundle' => 'DashboardBundle\\Entity', 'RankingBundle' => 'RankingBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_77abd99b35243ce960ef75c1246d38a5ffd8b2f713ce74450e0532f37e150942');
    ...
    /**
     * Gets the 'doctrine_cache.providers.gearman_cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getDoctrineCache_Providers_GearmanCacheService()
    {
        $this->services['doctrine_cache.providers.gearman_cache'] = $instance = new \Doctrine\Common\Cache\FilesystemCache((__DIR__.'/doctrine/cache/file_system'), NULL, 2);

        $instance->setNamespace('doctrine_cache.ns.gearman');

        return $instance;
    }

    /**
     * Gets the 'executenodefindcolor.worker' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \RankingBundle\Services\ExecuteNodeFindColor A RankingBundle\Services\ExecuteNodeFindColor instance
     */
    protected function getExecutenodefindcolor_WorkerService()
    {
        return $this->services['executenodefindcolor.worker'] = new \RankingBundle\Services\ExecuteNodeFindColor($this->get('doctrine'), $this);
    }
    ...
    {
        return $this->services['fos_js_routing.extractor'] = new \FOS\JsRoutingBundle\Extractor\ExposedRoutesExtractor($this->get('router'), array(0 => '[a-zA-z0-9_-]+'), __DIR__, array('FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle', 'SecurityBundle' => 'Symfony\\Bundle\\SecurityBundle\\SecurityBundle', 'TwigBundle' => 'Symfony\\Bundle\\TwigBundle\\TwigBundle', 'MonologBundle' => 'Symfony\\Bundle\\MonologBundle\\MonologBundle', 'SwiftmailerBundle' => 'Symfony\\Bundle\\SwiftmailerBundle\\SwiftmailerBundle', 'DoctrineBundle' => 'Doctrine\\Bundle\\DoctrineBundle\\DoctrineBundle', 'SensioFrameworkExtraBundle' => 'Sensio\\Bundle\\FrameworkExtraBundle\\SensioFrameworkExtraBundle', 'JMSSerializerBundle' => 'JMS\\SerializerBundle\\JMSSerializerBundle', 'FOSRestBundle' => 'FOS\\RestBundle\\FOSRestBundle', 'LexikJWTAuthenticationBundle' => 'Lexik\\Bundle\\JWTAuthenticationBundle\\LexikJWTAuthenticationBundle', 'NelmioCorsBundle' => 'Nelmio\\CorsBundle\\NelmioCorsBundle', 'FOSJsRoutingBundle' => 'FOS\\JsRoutingBundle\\FOSJsRoutingBundle', 'UserBundle' => 'UserBundle\\UserBundle', 'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle', 'VesselBundle' => 'VesselBundle\\VesselBundle', 'DashboardBundle' => 'DashboardBundle\\DashboardBundle', 'RankingBundle' => 'RankingBundle\\RankingBundle', 'TFoxMpdfPortBundle' => 'TFox\\MpdfPortBundle\\TFoxMpdfPortBundle', 'ObHighchartsBundle' => 'Ob\\HighchartsBundle\\ObHighchartsBundle', 'DoctrineCacheBundle' => 'Doctrine\\Bundle\\DoctrineCacheBundle\\DoctrineCacheBundle', 'GearmanBundle' => 'Mmoreram\\GearmanBundle\\GearmanBundle', 'DebugBundle' => 'Symfony\\Bundle\\DebugBundle\\DebugBundle', 'WebProfilerBundle' => 'Symfony\\Bundle\\WebProfilerBundle\\WebProfilerBundle', 'SensioDistributionBundle' => 'Sensio\\Bundle\\DistributionBundle\\SensioDistributionBundle', 'SensioGeneratorBundle' => 'Sensio\\Bundle\\GeneratorBundle\\SensioGeneratorBundle'));
    }
    ...
    protected function getFosRest_FormatNegotiatorService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'html', 1 => 'json', 2 => 'xml'), 'fallback_format' => NULL, 'prefer_extension' => false, 'methods' => NULL, 'attributes' => array(), 'stop' => false));
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/liip/customHandler', NULL, NULL, NULL, array()), array('fallback_format' => 'rss', 'methods' => NULL, 'attributes' => array(), 'stop' => false, 'prefer_extension' => '2.0', 'priorities' => array()));
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/liip/jsonp', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'jsonp'), 'fallback_format' => false, 'prefer_extension' => '2.0', 'methods' => NULL, 'attributes' => array(), 'stop' => false));
    ...
    {
        $this->services['fos_rest.view_handler'] = $instance = new \FOS\RestBundle\View\ViewHandler($this->get('router'), $this->get('fos_rest.serializer'), $this->get('templating'), $this->get('request_stack'), array('jsonp' => false, 'json' => false, 'xml' => false, 'html' => true), 400, 204, false, array('html' => 302), 'twig');
    ...
    /**
     * Gets the 'gearman' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mmoreram\GearmanBundle\Service\GearmanClient A Mmoreram\GearmanBundle\Service\GearmanClient instance
     */
    protected function getGearmanService()
    {
        $this->services['gearman'] = $instance = new \Mmoreram\GearmanBundle\Service\GearmanClient($this->get('gearman.cache.wrapper'), array('iterations' => 0, 'method' => 'doNormal', 'callbacks' => true, 'job_prefix' => NULL, 'generate_unique_key' => true, 'workers_name_prepend_namespace' => true, 'minimum_execution_time' => 0, 'timeout' => 0));

        $instance->initTaskStructure();
        $instance->setDefaultServers(array('localhost' => array('host' => '127.0.0.1', 'port' => '4730')));
        $instance->setGearmanCallbacksDispatcher($this->get('gearman.dispatcher.callbacks'));
        $instance->setUniqueJobIdentifierGenerator($this->get('gearman.unique_job_identifier'));
        $instance->setDefaultSettings(array('iterations' => 0, 'method' => 'doNormal', 'callbacks' => true, 'job_prefix' => NULL, 'generate_unique_key' => true, 'workers_name_prepend_namespace' => true, 'minimum_execution_time' => 0, 'timeout' => 0));

        return $instance;
    }

    /**
     * Gets the 'gearman.cache.wrapper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mmoreram\GearmanBundle\Service\GearmanCacheWrapper A Mmoreram\GearmanBundle\Service\GearmanCacheWrapper instance
     */
    protected function getGearman_Cache_WrapperService()
    {
        $a = $this->get('doctrine_cache.providers.gearman_cache');

        $this->services['gearman.cache.wrapper'] = $instance = new \Mmoreram\GearmanBundle\Service\GearmanCacheWrapper($this->get('gearman.parser'), $a, 'gearman.workers');

        $instance->load($a, 'gearman.workers');

        return $instance;
    }

    /**
     * Gets the 'gearman.command.cache_clear' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mmoreram\GearmanBundle\Command\GearmanCacheClearCommand A Mmoreram\GearmanBundle\Command\GearmanCacheClearCommand instance
     */
    protected function getGearman_Command_CacheClearService()
    {
        $this->services['gearman.command.cache_clear'] = $instance = new \Mmoreram\GearmanBundle\Command\GearmanCacheClearCommand();

        $instance->setKernel($this->get('kernel'));
        $instance->setGearmanCacheWrapper($this->get('gearman.cache.wrapper'));

        return $instance;
    }

    /**
     * Gets the 'gearman.command.cache_warmup' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mmoreram\GearmanBundle\Command\GearmanCacheWarmupCommand A Mmoreram\GearmanBundle\Command\GearmanCacheWarmupCommand instance
     */
    protected function getGearman_Command_CacheWarmupService()
    {
        $this->services['gearman.command.cache_warmup'] = $instance = new \Mmoreram\GearmanBundle\Command\GearmanCacheWarmupCommand();
    ...
    /**
     * Gets the 'gearman.command.job_describe' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mmoreram\GearmanBundle\Command\GearmanJobDescribeCommand A Mmoreram\GearmanBundle\Command\GearmanJobDescribeCommand instance
     */
    protected function getGearman_Command_JobDescribeService()
    {
        $this->services['gearman.command.job_describe'] = $instance = new \Mmoreram\GearmanBundle\Command\GearmanJobDescribeCommand();

        $instance->setKernel($this->get('kernel'));
        $instance->setGearmanClient($this->get('gearman'));
        $instance->setGearmanDescriber($this->get('gearman.describer'));

        return $instance;
    }

    /**
     * Gets the 'gearman.command.job_execute' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mmoreram\GearmanBundle\Command\GearmanJobExecuteCommand A Mmoreram\GearmanBundle\Command\GearmanJobExecuteCommand instance
     */
    protected function getGearman_Command_JobExecuteService()
    {
        $this->services['gearman.command.job_execute'] = $instance = new \Mmoreram\GearmanBundle\Command\GearmanJobExecuteCommand();

        $instance->setKernel($this->get('kernel'));
        $instance->setGearmanClient($this->get('gearman'));
        $instance->setGearmanDescriber($this->get('gearman.describer'));
        $instance->setGearmanExecute($this->get('gearman.execute'));

        return $instance;
    }

    /**
     * Gets the 'gearman.command.worker_describe' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mmoreram\GearmanBundle\Command\GearmanWorkerDescribeCommand A Mmoreram\GearmanBundle\Command\GearmanWorkerDescribeCommand instance
     */
    protected function getGearman_Command_WorkerDescribeService()
    {
        $this->services['gearman.command.worker_describe'] = $instance = new \Mmoreram\GearmanBundle\Command\GearmanWorkerDescribeCommand();
    ...
    /**
     * Gets the 'gearman.command.worker_execute' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mmoreram\GearmanBundle\Command\GearmanWorkerExecuteCommand A Mmoreram\GearmanBundle\Command\GearmanWorkerExecuteCommand instance
     */
    protected function getGearman_Command_WorkerExecuteService()
    {
        $this->services['gearman.command.worker_execute'] = $instance = new \Mmoreram\GearmanBundle\Command\GearmanWorkerExecuteCommand();
    ...
    /**
     * Gets the 'gearman.command.worker_list' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mmoreram\GearmanBundle\Command\GearmanWorkerListCommand A Mmoreram\GearmanBundle\Command\GearmanWorkerListCommand instance
     */
    protected function getGearman_Command_WorkerListService()
    {
        $this->services['gearman.command.worker_list'] = $instance = new \Mmoreram\GearmanBundle\Command\GearmanWorkerListCommand();
    ...
    /**
     * Gets the 'gearman.describer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mmoreram\GearmanBundle\Service\GearmanDescriber A Mmoreram\GearmanBundle\Service\GearmanDescriber instance
     */
    protected function getGearman_DescriberService()
    {
        return $this->services['gearman.describer'] = new \Mmoreram\GearmanBundle\Service\GearmanDescriber($this->get('kernel'));
    }

    /**
     * Gets the 'gearman.dispatcher.callbacks' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mmoreram\GearmanBundle\Dispatcher\GearmanCallbacksDispatcher A Mmoreram\GearmanBundle\Dispatcher\GearmanCallbacksDispatcher instance
     */
    protected function getGearman_Dispatcher_CallbacksService()
    {
        return $this->services['gearman.dispatcher.callbacks'] = new \Mmoreram\GearmanBundle\Dispatcher\GearmanCallbacksDispatcher($this->get('debug.event_dispatcher'));
    }

    /**
     * Gets the 'gearman.execute' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mmoreram\GearmanBundle\Service\GearmanExecute A Mmoreram\GearmanBundle\Service\GearmanExecute instance
     */
    protected function getGearman_ExecuteService()
    {
        $this->services['gearman.execute'] = $instance = new \Mmoreram\GearmanBundle\Service\GearmanExecute($this->get('gearman.cache.wrapper'), array('iterations' => 0, 'method' => 'doNormal', 'callbacks' => true, 'job_prefix' => NULL, 'generate_unique_key' => true, 'workers_name_prepend_namespace' => true, 'minimum_execution_time' => 0, 'timeout' => 0));
    ...
    /**
     * Gets the 'gearman.external.symfony_finder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getGearman_External_SymfonyFinderService()
    {
        return $this->services['gearman.external.symfony_finder'] = new \Symfony\Component\Finder\Finder();
    }

    /**
     * Gets the 'gearman.parser' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mmoreram\GearmanBundle\Service\GearmanParser A Mmoreram\GearmanBundle\Service\GearmanParser instance
     */
    protected function getGearman_ParserService()
    {
        return $this->services['gearman.parser'] = new \Mmoreram\GearmanBundle\Service\GearmanParser($this->get('kernel'), $this->get('annotation_reader'), $this->get('gearman.external.symfony_finder'), array('AppBundle' => array('name' => 'RankingBundle', 'active' => true, 'include' => array(0 => 'Services'), 'ignore' => array(0 => 'DependencyInjection', 1 => 'Resources'))), array('localhost' => array('host' => '127.0.0.1', 'port' => '4730')), array('iterations' => 0, 'method' => 'doNormal', 'callbacks' => true, 'job_prefix' => NULL, 'generate_unique_key' => true, 'workers_name_prepend_namespace' => true, 'minimum_execution_time' => 0, 'timeout' => 0));
    }

    /**
     * Gets the 'gearman.unique_job_identifier' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mmoreram\GearmanBundle\Generator\UniqueJobIdentifierGenerator A Mmoreram\GearmanBundle\Generator\UniqueJobIdentifierGenerator instance
     */
    protected function getGearman_UniqueJobIdentifierService()
    {
        return $this->services['gearman.unique_job_identifier'] = new \Mmoreram\GearmanBundle\Generator\UniqueJobIdentifierGenerator(true);
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/Resources/config/serializer'), 'Lexik\\Bundle\\JWTAuthenticationBundle' => ($this->targetDirs[3].'/vendor/lexik/jwt-authentication-bundle/Resources/config/serializer'), 'Nelmio\\CorsBundle' => ($this->targetDirs[3].'/vendor/nelmio/cors-bundle/Resources/config/serializer'), 'FOS\\JsRoutingBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/jsrouting-bundle/Resources/config/serializer'), 'UserBundle' => ($this->targetDirs[3].'/src/UserBundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/config/serializer'), 'VesselBundle' => ($this->targetDirs[3].'/src/VesselBundle/Resources/config/serializer'), 'DashboardBundle' => ($this->targetDirs[3].'/src/DashboardBundle/Resources/config/serializer'), 'RankingBundle' => ($this->targetDirs[3].'/src/RankingBundle/Resources/config/serializer'), 'TFox\\MpdfPortBundle' => ($this->targetDirs[3].'/vendor/tfox/mpdf-port-bundle/TFox/MpdfPortBundle/Resources/config/serializer'), 'Ob\\HighchartsBundle' => ($this->targetDirs[3].'/vendor/ob/highcharts-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineCacheBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-cache-bundle/Resources/config/serializer'), 'Mmoreram\\GearmanBundle' => ($this->targetDirs[3].'/vendor/mmoreram/gearman-bundle/Mmoreram/GearmanBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Resources/config/serializer')));
    ...
    {
        return $this->services['lexik_jwt_authentication.jwt_token_authenticator'] = new \Lexik\Bundle\JWTAuthenticationBundle\Security\Guard\JWTTokenAuthenticator($this->get('lexik_jwt_authentication.jwt_manager'), $this->get('debug.event_dispatcher'), $this->get('lexik_jwt_authentication.extractor.chain_extractor'));
    }
    ...
    {
        return $this->services['lexik_jwt_authentication.key_loader'] = new \Lexik\Bundle\JWTAuthenticationBundle\Services\KeyLoader\OpenSSLKeyLoader(($this->targetDirs[2].'/../var/jwt/private.pem'), ($this->targetDirs[2].'/../var/jwt/public.pem'), 'star123');
    }
    ...
    /**
     * Gets the 'log.update.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\EventListener\LogDetailsListeners A UserBundle\EventListener\LogDetailsListeners instance
     */
    protected function getLog_Update_ListenerService()
    {
        return $this->services['log.update.listener'] = new \UserBundle\EventListener\LogDetailsListeners($this, $this->get('session'), '127.0.0.1', 'root', 'star123', 'incident');
    }
    ...
    {
        return $this->services['nelmio_cors.options_provider.config'] = new \Nelmio\CorsBundle\Options\ConfigProvider(array('^/' => array('origin_regex' => true, 'allow_origin' => true, 'allow_headers' => array(0 => 'content-type', 1 => 'authorization'), 'allow_methods' => array(0 => 'POST', 1 => 'PUT', 2 => 'GET', 3 => 'DELETE'), 'max_age' => 3600)), array('allow_origin' => array(), 'allow_credentials' => false, 'allow_headers' => array(), 'expose_headers' => array(), 'allow_methods' => array(), 'max_age' => 0, 'hosts' => array(), 'origin_regex' => false));
    }
    ...
    protected function getRouting_LoaderService()
    {
        ...
        $f->addLoader(new \FOS\RestBundle\Routing\Loader\RestRouteLoader($this, $b, $a, new \FOS\RestBundle\Routing\Loader\Reader\RestControllerReader(new \FOS\RestBundle\Routing\Loader\Reader\RestActionReader($c, $this->get('fos_rest.request.param_fetcher.reader'), $this->get('fos_rest.inflector'), true, array('jsonp' => false, 'json' => false, 'xml' => false, 'html' => true)), $c), NULL));
        $f->addLoader(new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($b, $e, true, array('jsonp' => false, 'json' => false, 'xml' => false, 'html' => true), NULL));
        $f->addLoader(new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($b, $e, true, array('jsonp' => false, 'json' => false, 'xml' => false, 'html' => true), NULL));
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/(_(profiler|wdt|doc))/'), 'security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/login'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_ApiService()
    {
        ...
        $c = $this->get('app.jwt_token_authenticator');
        $d = $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE);

        return $this->services['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout')), 2 => new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($this->get('security.authentication.guard_handler'), $this->get('security.authentication.manager'), 'api', array(0 => $c), $d), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'api', $c, NULL, NULL, $d, true));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/VesselBundle/Resources/views'), 'Vessel');
        $instance->addPath(($this->targetDirs[3].'/src/DashboardBundle/Resources/views'), 'Dashboard');
        $instance->addPath(($this->targetDirs[3].'/src/RankingBundle/Resources/views'), 'Ranking');
    ...
    /**
     * Gets the 'lexik_jwt_authentication.extractor.chain_extractor' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['lexik_jwt_authentication.extractor.chain_extractor'] = new \Lexik\Bundle\JWTAuthenticationBundle\TokenExtractor\ChainTokenExtractor(array(0 => $this->get('lexik_jwt_authentication.extractor.authorization_header_extractor')));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $c = new \FOS\UserBundle\Security\UserProvider($a);

        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($c, $b, 'login', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('598db210dcd647.35139193'), 2 => new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(array(0 => $this->get('app.jwt_token_authenticator')), $c, 'api', $b)), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'VesselBundle' => 'VesselBundle\\VesselBundle',
                'DashboardBundle' => 'DashboardBundle\\DashboardBundle',
                'RankingBundle' => 'RankingBundle\\RankingBundle',
                ...
                'GearmanBundle' => 'Mmoreram\\GearmanBundle\\GearmanBundle',
            ...
            'lexik_jwt_authentication.pass_phrase' => 'star123',
            ...
            'gearman.default.settings' => array(
                'iterations' => 0,
                'method' => 'doNormal',
                'callbacks' => true,
                'job_prefix' => NULL,
            ...
            'gearman.default.settings.generate_unique_key' => true,
            ...
            'gearman.command.cache_warmup.class' => 'Mmoreram\\GearmanBundle\\Command\\GearmanCacheWarmupCommand',
            'gearman.command.job_describe.class' => 'Mmoreram\\GearmanBundle\\Command\\GearmanJobDescribeCommand',
            'gearman.command.job_execute.class' => 'Mmoreram\\GearmanBundle\\Command\\GearmanJobExecuteCommand',
            'gearman.command.worker_describe.class' => 'Mmoreram\\GearmanBundle\\Command\\GearmanWorkerDescribeCommand',
            'gearman.command.worker_execute.class' => 'Mmoreram\\GearmanBundle\\Command\\GearmanWorkerExecuteCommand',
            'gearman.command.worker_list.class' => 'Mmoreram\\GearmanBundle\\Command\\GearmanWorkerListCommand',
            ...
            'console.command.ids' => array(
                0 => 'gearman.command.cache_clear',
                1 => 'gearman.command.cache_warmup',
                2 => 'gearman.command.job_describe',
                3 => 'gearman.command.job_execute',
                4 => 'gearman.command.worker_describe',
                5 => 'gearman.command.worker_execute',
                6 => 'gearman.command.worker_list',
                7 => 'sensio_distribution.security_checker.command',
            ),
        );
    }
}
