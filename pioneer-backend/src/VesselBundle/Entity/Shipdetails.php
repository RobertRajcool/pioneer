 ...
 * Shipdetails
 *
 * @ORM\Table(name="shipdetails")
 * @ORM\Entity(repositoryClass="VesselBundle\Repository\ShipdetailsRepository")
 */
...
class Shipdetails
{
    ...
    /**
     * @var string
     * @ORM\ManyToOne(targetEntity="VesselBundle\Entity\ShipTypes", cascade={"persist"})
     * @ORM\JoinColumns({
     ...
     * @var string
     *
     * @ORM\Column(name="companyName", type="string", length=125)
     */
    ...
    /**
     * @var string
     * @ORM\ManyToOne(targetEntity="VesselBundle\Entity\AppsCountries", cascade={"persist"})
     * @ORM\JoinColumns({
